...
GetName("20112", "new york 6th street") ;  // This function call refers the global object. to make this.name set to particular object we use call()
...
GetDetailsVehicle.call(BMW,"Electric",2021, 2000, 2200, "red") // gives same as apply()