...
var Stu2=new Object(User)
console.log(Student.getName); //Because of prototyping
...
console.log(Stu2.getAddress()) //Somewhere in the world
console.log("-----------------------------------") //Somewhere in the world
